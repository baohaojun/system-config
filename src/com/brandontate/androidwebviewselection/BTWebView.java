...
public class BTWebView extends WebView implements TextSelectionJavascriptInterfaceListener, 
    ...
    private final String html_head = "<html> <head> <script src='jquery.js'></script> <script src='rangy-core.js'></script> <script src='rangy-serializer.js'></script> <script src='android.selection.js'></script> </head> <body>";
	...
	mDict = new StarDict("/sdcard/ahd/ahd");

	String hello = html_head + mDict.getExplanation("hello").get(0) + html_tail;
	// Load the url
	this.loadDataWithBaseURL("file:///sdcard/ahd/JPG/", hello, "text/html", "UTF8", null);
