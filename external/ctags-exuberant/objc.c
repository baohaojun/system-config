 ...
 * why though. */
static void tillToken (vString * const ident, objcToken what)
{
        if (what == waitedToken)
                toDoNext = comeAfter;
}

static void tillTokenOrFallBack (vString * const ident, objcToken what)
{
        if (what == waitedToken)
                toDoNext = comeAfter;
...
static void ignoreBalanced (vString * const ident, objcToken what)
{
        static int count = 0;
...
static void ignorePreprocStuff (vString * const ident, objcToken what)
{
