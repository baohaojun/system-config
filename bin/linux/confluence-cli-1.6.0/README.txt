...
-- Run java -jar release/confluence-cli-x.x.x.jar
...
- It is recommended that you open the confluene.bat or confluence.sh file with an editor and customize it for your environment by adding server, user, and password parameters.
