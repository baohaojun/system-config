...
* DONE understand uboot source code
...
** TODO emmc spec/standard
   :PROPERTIES:
   :ID:       1ea357c0-bd66-4039-ace4-ec082c9fa4cf
   :END:
...
* TODO refactor uboot source code
  :PROPERTIES:
  :ID:       9da1cd62-5c8a-4139-9435-1f04f008df23
  :END:
* DONE Work on tickets of xiaolin
  CLOSED: [2013-07-04 Thu 09:46]
* TODO Fix uboot compile warnings
  :PROPERTIES:
  :ID:       9dfb01c9-587d-425f-a25f-a1a54043615c
  :END:

* TODO 脚本stardict 2 crossdict
  :PROPERTIES:
  :ID:       90f14c1d-5c48-4047-b6f3-64b0fbebe7c5
  :END:
* bt scan slow
