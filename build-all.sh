...
if is-platform-needed ubuntu; then
    (
        ...
        ssh-quote trusty ". ~/.profile; export DOING_WRENCH_RELEASE=true; PATH=~/external/local/qt5-ubuntu-1404/bin/:\$PATH; cd $PWD; bash $bashx ./build-linux.sh -r Wrench-ubuntu-14.04"
