(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet yari yaml-mode yagist whole-line-or-region whitespace-cleanup-mode wgrep vc-darcs unicode-fonts unfill undo-tree tidy textile-mode tagedit switch-window sql-indent smarty-mode skewer-less session scss-mode scratch sass-mode ruby-hash-syntax robe rinari regex-tool redshank rainbow-mode rainbow-delimiters project-local-variables pretty-mode pip-requirements php-mode paredit-everywhere page-break-lines org-pomodoro org-mime org-fstree org oauth2 mwe-log-commands multiple-cursors move-text move-dup mmm-mode maxframe marmalade markdown-mode magit-svn magit-gh-pulls macrostep lua-mode lively less-css-mode ledger-mode keydef json-mode js-comint ipretty ibuffer-vc htmlize hl-sexp hippie-expand-slime highlight-symbol highlight-quoted highlight-escape-sequences hi2 hayoo guide-key gnuplot gitignore-mode github-clone github-browse-file gitconfig-mode git-timemachine git-messenger git-gutter-fringe git-blame ghci-completion fullframe flycheck-package flycheck-ledger flycheck-hdevtools flycheck-haskell flycheck-clojure fill-column-indicator f expand-region exec-path-from-shell ess erlang elisp-slime-nav elein eldoc-eval dts-mode dsvn dired-sort dired+ diminish diff-hl default-text-scale darcsum csv-nav csv-mode css-eldoc csharp-mode crontab-mode coffee-mode clojure-test-mode cljsbuild-mode cl-lib-highlight bug-reference-github bbyac bbdb-vcard auto-complete-clang auto-compile anzu aggressive-indent ace-jump-mode ac-slime ac-nrepl ac-js2 ac-inf-ruby ac-helm ac-haskell-process ac-clang ac-cider)))
