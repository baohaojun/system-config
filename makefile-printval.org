...
敲完代码到他/她看到结果，中间需要步骤越多、时间（编译、运行等）越长，他
就越“苦逼”。这大概跟一个很有趣的研究有点共通之处：把一个人的听觉用仪器
分离出去，再让他说话，但他发出的声音要在半分钟后才让他听见。据说参加实
验的人很快就失去语言能力甚至出现精神失常... 又，巴甫洛夫的条件反射也是
同样的道理：每次你养的狗狗乖乖按你的指示做了，但你都在半个小时或者一堆
莫名其妙的仪式后才奖给它一块肉吃，狗狗肯定会觉得很无奈吧，说不定会离家
出走:-)
