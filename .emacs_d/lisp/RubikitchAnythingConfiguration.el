...
(setq anything-c-locate-db-file "~/.logs/home.simple.locatedb")
...
(defvar anything-c-source-rubylib-18
  '((name . "Ruby 1.8 libraries")
    (candidates-file "~/.logs/ruby-libraries.18.filelist" updating)
    (requires-pattern . 4)
    (type . file)
...
(defvar anything-c-source-rubylib-19
  '((name . "Ruby 1.9 libraries")
    (candidates-file "~/.logs/ruby-libraries.19.filelist" updating)
    (requires-pattern . 4)
    (type . file)
    (major-mode ruby-mode el4r-mode)))
...
(defvar anything-c-source-ruby18-source
  '((name . "Ruby 1.8 source")
    (candidates-file "~/.logs/rubysrc-files.18.filelist" updating)
    (requires-pattern . 4)
    (type . file)
    (major-mode ruby-mode el4r-mode)))
...
(defvar anything-c-source-ruby19-source
  '((name . "Ruby 1.9 source")
    (candidates-file "~/.logs/rubysrc-files.19.filelist" updating)
    (requires-pattern . 4)
    (type . file)
    (major-mode ruby-mode el4r-mode)))
...
(defvar anything-c-source-home-directory
  '((name . "Home directory")
    (candidates-file "~/.logs/home.filelist" updating)
    (requires-pattern . 5)
...
(defvar anything-c-source-compile-directory
  '((name . "Compile directory")
    (candidates-file "~/.logs/compile.filelist" updating)
    (requires-pattern . 8)
    (candidate-number-limit . 20)
    (delayed)
    (type . file)))
...
(defvar anything-c-source-find-library
  '((name . "Elisp libraries")
    (candidates-file "~/.logs/elisp.filelist" updating)
    (requires-pattern . 4)
    (type . file)
...
(defvar anything-c-source-call-seq-ruby18
  (anything-c-source-global-call-seq
   '((name . "Ruby 1.8 call-seq")
     (call-seq-file . "~/.logs/compile/ruby18/CALLSEQ"))))
(defvar anything-c-source-call-seq-ruby19
  (anything-c-source-global-call-seq
   '((name . "Ruby 1.9 call-seq")
     (call-seq-file . "~/.logs/compile/ruby19/CALLSEQ"))))
