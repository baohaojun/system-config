...
(defun bhj-occur-make-errors ()
  (interactive)
  (let ((bhj-occur-regexp (downcase "\\*\\*\\*.*stop\\|method does not override or implement\\|syntax error\\|invalid argument\\|no such \\|circular.*dropped\\|no rule to\\|failed\\|[0-9]elapsed \\|cannot find symbol\\|error [0-9]\\| : error \\|because of errors\\|[0-9] error\\b\\|error:\\|error while loading shared libraries\\|undefined symbol\\|undefined reference to\\|permission denied")))
