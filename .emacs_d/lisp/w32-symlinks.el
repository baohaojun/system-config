...
;; Copyright (C) 2002, 2003 Francis J. Wright

;; Author: Francis J. Wright <F.J.Wright at qmul.ac.uk>
;; Time-stamp: <04 May 2003>
;; URL: http://centaur.maths.qmul.ac.uk/Emacs/
;; Keywords: convenience, files, unix

;; $Id: w32-symlinks.el,v 1.19 2003/05/04 11:16:00 fjw Exp $
...
(mapc
 ...
 '(
   ;; Constant return value (in a list to distinguish nil from unset):
   (file-regular-p			(nil))
   (file-symlink-p			(t))
   ...
   (file-attributes			w32-symlinks-operate-on-source)
