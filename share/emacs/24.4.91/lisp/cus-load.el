...
(put 'basic-faces 'custom-loads '(cus-edit fringe shadowfile))
...
(put 'frames 'custom-loads '(desktop ediff-wind fringe imenu scroll-bar two-column))
...
(put 'image 'custom-loads '(iimage image image-file image-mode))
...
(put 'mouse 'custom-loads '(artist avoid cus-edit goto-addr msb mwheel strokes))
