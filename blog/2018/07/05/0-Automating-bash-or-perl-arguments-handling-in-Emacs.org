...
The Perl style getopt is added recently, where I tried to use [[https://github.com/baohaojun/system-config/raw/master/bin/.replace-%25%25][a script inspired by ANTLR's string-template]], and the code is a lot better.
