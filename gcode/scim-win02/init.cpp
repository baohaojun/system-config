    ...
    HINSTANCE hInstL)
{
    ...
    wcWndCls.hIcon         = (HICON)LoadImage(hInstL, MAKEINTRESOURCE(IDI_IME),
    ...
    wcWndCls.hIconSm       = (HICON)LoadImage(hInstL, MAKEINTRESOURCE(IDI_IME),
    ...
    LPVOID    lpvReserve)       // reserve pointer
{
    ...
    EnterLeaveDebug();
    switch (fdwReason) {
    case DLL_PROCESS_ATTACH:BHJDEBUG("case DLL_PROCESS_ATTACH");
        DisableThreadLibraryCalls(hInstance);
        RegisterIme(hInstance);

        sImeL.dwRegImeIndex = 2;
        ...
        break;
    case DLL_PROCESS_DETACH:BHJDEBUG("case DLL_PROCESS_DETACH");
    {
        WNDCLASSEX wcWndCls;
