...
sImeG.yCandHi =
	sImeG.rcCandText.bottom + sImeG.cyCandBorder * 2 + cyBorder * 4;
...
lpImeL->rcCompText.right =
    lpImeL->rcCompText.left + sImeG.xChiCharWi * ((lpImeL->nMaxKey + 2) / 2);
...
lpImeL->yCompHi =
    lpImeL->rcCompText.bottom + lpImeL->cyCompBorder * 2 + cyBorder * 4;
