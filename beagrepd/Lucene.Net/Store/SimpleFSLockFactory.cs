...
namespace Lucene.Net.Store
{
	...
	class SimpleFSLock : Lock
	{
		...
		public override bool Obtain()
		{
		    ...
		    if (fd == -1) {
			    ...
			    if (error == Mono.Unix.Native.Errno.ENOSPC)
				    throw new Beagrep.Util.NoSpaceException ();
			    else
		...
		catch (Beagrep.Util.NoSpaceException e)
		{
			throw e;
		}
                catch (Exception e)
		...
		{
			Beagrep.Util.FileSystem.PosixDelete (lockFile.FullName);

			if (System.IO.File.Exists(lockFile.FullName)) {
				Beagrep.Util.Logger.Log.Warn ("Release didnt delete lockfile {0}.", lockFile.FullName);
			}
		}
		...
		static public Beagrep.Util.Logger Logger = null;
		//static public Beagrep.Util.Logger Logger = Beagrep.Util.Logger.Log;
